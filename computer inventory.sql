...
-- User
INSERT INTO User (FirstName, LastName, Department, Email, Phone)
VALUES
...
-- ============================================
-- VERIFY RELATIONSHIPS (sample queries)
-- ============================================

-- Which computer is assigned to which user
SELECT u.FirstName, u.LastName, c.Manufacturer, c.Model, a.AssignmentDate
FROM Assignment a
JOIN User u ON a.UserID = u.UserID
JOIN Computer c ON a.ComputerID = c.ComputerID;

-- Which user is in which location
SELECT u.FirstName, u.LastName, l.Building, l.RoomNumber, ul.UserLocationDate
